...
function Quotation() {
  ...
  const [activePage, setActivePage] = useState('create'); // 'create' or 'list'
  ...
  //       includeSetup,
  //       expressShipping,
  //       frontPage,  // Pass front page config
  //       backPage,   // Pass back page config
  //       attachments: attachments.map(file => ({ name: file.name })) // Pass attachment names
  //     };

  //     const pdfDoc = generateQuotationPdf(quotationData);
  //     pdfDoc.save(`quotation_${quotationData.customerName}_${new Date().toISOString().slice(0, 10)}.pdf`);
  ...
  //   try {
  //     // Process all attachments (images + PDFs)
  ...
  //       frontPage,
  //       backPage,
  //       attachments: processedAttachments  // Pass processed data
  //     };
  ...
  // };
      ...
      try {
        // Process all attachments - FIXED LOGIC
        const processedAttachments = await processFileAttachments(attachments);
  ...
  const QuotationList = () => {
    ...
    const quotations = [
      { id: 'EST-1001', customer: 'TechCorp', amount: 4200, date: '2023-06-01', status: 'Approved' },
      { id: 'EST-1002', customer: 'Global Solutions', amount: 7850, date: '2023-06-05', status: 'Pending' },
      { id: 'EST-1003', customer: 'Innovate Inc', amount: 3200, date: '2023-06-08', status: 'Rejected' },
      { id: 'EST-1004', customer: 'Data Systems', amount: 15200, date: '2023-06-12', status: 'Approved' },
    ];
                  ...
                  <tr key={quote.id}>
                    ...
                    <td>
                      <span className={`badge ${
                        ...
                        quote.status === 'Pending' ? 'bg-warning' : 'bg-danger'
                      }`}>
                        {quote.status}
                      </span>
                    </td>
