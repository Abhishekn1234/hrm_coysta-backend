...
function Quotation() {
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      const pdfDoc = generateQuotationPdf(quotationData, frontPage, backPage);
  ...
  const saveQuotationData = async (quotationData) => {
    try {
      const response = await axios.post('/api/v1/quotations', {
        ...quotationData,
                      ...
                      <div className="accordion mt-4" id="pdfCustomizationAccordion">
                        <div className="accordion-item">
                          <h2 className="accordion-header">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#pdfCustomization">
                              PDF Customization Options
                            </button>
                          </h2>
                          <div id="pdfCustomization" className="accordion-collapse collapse" data-bs-parent="#pdfCustomizationAccordion">
