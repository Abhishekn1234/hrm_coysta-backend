...
function Quotation() {
  ...
  // useEffect(() => {
  //   if (editingQuotation) {
  //     setSelectedCustomer({ id: editingQuotation.customer_id, name: editingQuotation.customer_name });
  ...
  //     setSubtotal(editingQuotation.subtotal);
  //     setDiscount(editingQuotation.discount);
  //     setTax(editingQuotation.tax);
  //     setTotalAmount(editingQuotation.total_amount);
  ...
  useEffect(() => {
    if (editingQuotation) {
      ...
      if (customer) {
        ...
        // Fallback if customer not found in mockCustomers
        setSelectedCustomer({ 
          ...
          >
            ...
            <td>
              ...
              <input
                ...
                min="1"
                max={item.available}
                value={selectedItems.find(si => si.id === item.id)?.qty ?? 1}  // Ensure never undefined
                onChange={(e) => handleQtyChangeInventory(item.id, e.target.value)}
                style={{ maxWidth: "100px" }}
              />
            </td>
  ...
  const handleGeneratePdf = async () => {
    ...
    try {
      ...
      const pdfDoc = generateQuotationPdf(quotationData);
      pdfDoc.save(`quotation_${quotationData.customerName}.pdf`);
  ...
  const saveQuotationData = async (quotationData) => {
    try {
      console.log('Saving with customerId:', selectedCustomer?.id);
  ...
  const QuotationList = () => {
    // Note: This component displays all quotations without pagination
                  ...
                  >
                    <div className="col-md-4 position-relative">
                      ...
                      {filteredCustomers.length > 0 && (
                        <div
                          className="customer-dropdown position-absolute z-3 bg-white mt-1 w-100"
                        >
                    ...
                    <div className="col-md-4">
                      ...
                      <select
                      className="form-select border-primary-subtle"
                      value={selectedCustomerType ?? ""}  // Ensure never undefined
                      onChange={(e) => setSelectedCustomerType(e.target.value)}
                      required
                      style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.3)' }}
                    >
                    ...
                    <div className="col-md-6">
                      ...
                      <input
                        type="text"
                        className="form-control border-secondary-subtle"
                        value={projectName ?? ""}  // Ensure never undefined
                        onChange={(e) => setProjectName(e.target.value)}
                        required
                        style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.3)' }}
                      />
                    ...
                    <div className="col-md-4">
                      ...
                      <input
                        type="tel"
                        className="form-control"
                        value={phone ?? ""}  // Ensure never undefined
                        onChange={(e) => setPhone(e.target.value)}
                        style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.3)' }}
                      />
                    </div>
                    ...
                    <div className="col-md-4">
                      <label className="form-label" style={{ fontWeight: 600 }}>Client Mail</label>
                      {/* <input
                        type="email"
                        className="form-control"
                        value={email}
                    ...
                    <div className="col-md-3">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        value={location ?? ""}  // Ensure never undefined
                        onChange={(e) => setLocation(e.target.value)}
                        style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.3)' }}
                      />
                    </div>
                                    ...
                                    <tr key={si.id}>
                                      ...
                                      <td>
                                        ...
                                        <input
                                          ...
                                          min="1"
                                          max={si.available}
                                          value={si.qty ?? 1}  // Ensure never undefined
                                          onChange={(e) => handleQtyChangeSelected(si.id, e.target.value)}
                                          style={{ maxWidth: "80px" }}
                                        />
                                      </td>
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <div className="mb-3">
                                      ...
                                      /> */}<input 
                                              type="text" 
                                              className="form-control" 
                                              value={frontPage.title ?? ""}  // Ensure never undefined
                                              onChange={(e) => handleFrontPageChange('title', e.target.value)}
                                            />
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <textarea 
                                        className="form-control" 
                                        rows="3"
                                        value={frontPage.content ?? ""}  // Ensure never undefined
                                        onChange={(e) => handleFrontPageChange('content', e.target.value)}
                                      />
                                    </div>
                                  </div>
                                  <div className="col-md-6">
                                    ...
                                    <div className="mb-3">
                                      ...
                                      <input 
                                        type="text" 
                                        className="form-control" 
                                        value={backPage.title ?? ""}  // Ensure never undefined
                                        onChange={(e) => handleBackPageChange('title', e.target.value)}
                                      />
                                    </div>
                                    <div className="mb-3">
                                      ...
                                      <textarea 
                                        className="form-control" 
                                        rows="3"
                                        value={backPage.content ?? ""}  // Ensure never undefined
