...
function Quotation() {
  ...
  //               </div>
  //               <div className="mb-3">
  //                 <label className="form-label">Notes <span style={{ color: 'red' }}>*</span></label>
  //                 <textarea
  ...
  //                 />
  //                 {!actionNotes.trim() && (
  //                   <div className="text-danger small mt-1">Notes are required</div>
  //                 )}
  //               </div>
  //             </div>
  ...
  //                 onClick={onSubmit}
  //                 disabled={!actionType || !actionNotes.trim()}
  //               >
  //                 Submit
  //               </button>
  //             </div>
