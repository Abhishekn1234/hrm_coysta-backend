      ...
      <div className="content py-3 px-0">
        <div className="container">
          <div className="card w-100" style={{ boxShadow: '0 0.5rem 1rem rgba(0, 0, 0, 0.15)' }}>
            <div className="card-header" style={{ background: 'linear-gradient(120deg, #3a7bd5, #00d2ff)', color: 'white', borderRadius: '10px 10px 0 0' }}>
              <ul className="nav nav-tabs card-header-tabs" style={{ color: 'white' }}>
                <li className="nav-item">
                  <a className={`bi bi-box-seam nav-link ${activeTab === 'grouping' ? 'active' : ''}`} style={{ color: activeTab === 'grouping' ? 'white' : '#ccc' }} onClick={() => setActiveTab('grouping')}>Inventory Grouping</a>
                </li>
                <li className="nav-item">
                  <a className={`bi bi-list nav-link ${activeTab === 'list' ? 'active' : ''}`} style={{ color: activeTab === 'list' ? 'white' : '#ccc' }} onClick={() => setActiveTab('list')}>Inventory List</a>
                </li>
              </ul>
              <p className="text-light mb-0" style={{ fontSize: '0.9rem', marginLeft: '10px' }}>
