...
<body style="background-color: #ececec;margin:0;padding:0">
    ...
    <div
        style="width:650px;margin:auto; background-color:white;margin-top:100px; 
                    ...
                    <td>
                        <div style="text-align: right; margin-right:15px;">
                            ...
                            <img style="max-width:250px;border:0;"
                                src="{{ asset('/storage/app/public/company/' . $logo) }}" title="" class="sitelogo"
                                width="60%" alt="" />
                        </div>
                    </td>
                </tr>
                ...
                <tr style="width: 100%;">
                    <td style="width:50%;vertical-align: top; margin-top:5px;">
                        ...
                        <div style="text-align:left;margin-top:10px;">
                            <span
                                style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{ \App\CPU\translate('seller_details') }}
                            </span><br>
                            ...
                            @if ($order->seller_is == 'seller')
                                <div style="display:flex; align-items:center;margin-top:10px;">
                                    ...
                                    <img style="border:0;border-radius:50%;"
                                        src="{{ asset('/storage/app/public/shop/' . $shop->image) }}" title=""
                                        class="sitelogo" width="20%" alt="" />

                                    <span
                                        style="padding-left: 5px;">{{ $seller->f_name . ' ' . $seller->l_name }}</span>
                                </div>
                            @else
                                <div style="display:flex; align-items:center;margin-top:10px;">
                                    <span>
                    ...
                    <td style="width:50%;vertical-align: top;">
                        <div style="text-align:right;margin-top:10px;">
                            <span
                                style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{ \App\CPU\translate('payment_details') }}
                            </span><br>
                    ...
                    <table style="width: 46%;margin-left:41%; display: inline;text-transform: capitalize; ">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($sub_total)) }}
                                </td>

                            </tr>
                            <tr>
                                <td>{{ \App\CPU\translate('tax') }} : </td>
                                <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_tax)) }}
                                </td>
                            </tr>
                            @if ($order->order_type == 'default_type')
                                <tr>
                                    <td>{{ \App\CPU\translate('shipping') }} : </td>
                                    <td>{{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($shipping)) }}
                                    </td>
                                </tr>
                            @endif
                            <tr>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td>
                                    -
                                    {{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_discount_on_product)) }}
                                </td>
                            </tr>
                            @if ($order->order_type != 'default_type')
                                <tr class="border-bottom">
                            ...
                            @endif
                            <tr class="bg-primary">
                                <th class="text-left"><b class="text-white">{{ \App\CPU\translate('total') }} : </b>
                                </th>
                                <td class="text-white">
                ...
                <tr>
                    <td>
                        ...
                        <div style="margin-top: 50px; margin-bottom:30px">
                            <a href="{{ route('track-order.result', ['order_id' => $order->id, 'phone_number' => $user_phone]) }}"
                                style="background-color: #1a82e2; padding:20px;border:none;
                                ...
                                @foreach ($social_media as $item)
                                    <div class="">
                                        <a href="{{ $item->link }}" target=”_blank”>
                                            <img src="{{ asset('assets/back-end/img/' . $item->name . '.png') }}"
