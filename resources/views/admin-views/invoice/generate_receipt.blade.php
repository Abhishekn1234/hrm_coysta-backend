...
<html lang="en">
    <head>
        ...
        <title>{{ $proposal ? $proposal->proposal_title : 'Receipt' }} - Cosysta</title>
        <style>
            @media print {
                @page {
                    margin: 0;
        ...
        <div class="page">
            ...
            <div style="">
                <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                    <div>
                        <h2 style="color: var(--primary);">Receipt : {{ $receipt->receipt_number }}</h2>
                        <p style="font-size: 0.9em; color: var(--text);">Invoice : {{ $invoice->invoice_number }}</p>
                    </div>
                    <div style="text-align: right;">
                        <p style="margin: 0;">Date: {{date('d M Y',strtotime($receipt->receipt_date))}}</p>
                    </div>
                </div>
            ...
            <div style="margin-top: 1rem;">
                <div class="info-card">
                    ...
                    <?php if(count($items) > 0) { ?>
                        <p>Balance : ₹ {{ $total - $receipt_list->sum('amount_paid') }}</p>
                    <?php } ?>
