...
<html lang="en">
    <head>
        ...
        <title>{{ $proposal ? $proposal->proposal_title : 'Quotation' }} - Cosysta</title>
        <style>
            @media print {
                @page {
                    margin: 0;
        ...
        <div class="page">
            ...
            <div style="">
                <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                    <div>
                        <h2 style="color: var(--primary);">Quotation : {{ $quotation->quotation_number }}</h2>
                        
                        <?php if($proposal) { ?>
                            <p style="font-size: 0.9em; color: var(--text);">Proposal : {{ $proposal->proposal_title }}</p>
                        <?php } ?>
                    </div>
                    <div style="text-align: right;">
                        <p style="margin: 0;">Date: {{date('d M Y',strtotime($quotation->quotation_date))}}</p>
                        <p style="margin: 0;">Valid Until: {{date('d M Y',strtotime($quotation->due_date))}}</p>
                    </div>
                </div>
