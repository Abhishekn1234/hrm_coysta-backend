    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ \App\CPU\translate('offer_letters') }}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ \App\CPU\translate('Offer Letter') }} {{ \App\CPU\translate('Table') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a title="{{ \App\CPU\translate('View') }}" target="_blank"
                                                    ...
                                                    href="{{ route('admin.document.generate_offer_letter', [$de_p->id]) }}">
                                                    View Offer Letter
                                                </a>
                                            </td>
                            ...
                            @if (count($letters) == 0)
                                <div class="text-center p-4">
                                    ...
                                    <p class="mb-0">{{ \App\CPU\translate('No offer letter issued') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
