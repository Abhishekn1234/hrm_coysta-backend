    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ \App\CPU\translate('experiences') }}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ \App\CPU\translate('experiences') }} {{ \App\CPU\translate('Table') }}</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <a title="{{ \App\CPU\translate('View') }}" target="_blank"
                                                    ...
                                                    href="{{ route('admin.document.generate_experience_certificate', [$de_p->id]) }}">
