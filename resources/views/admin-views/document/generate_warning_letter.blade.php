...
<html lang="en">
    <head>
        ...
        <title>Warning Letter - Cosysta</title>
        <style>
            @media print {
                @page {
                    margin: 0;
        ...
        <div class="page">
            ...
            <div style="">
                <div style="display: flex; justify-content: space-between; margin-bottom: 1rem;">
                    <div>
                        <h2 style="color: var(--primary);">WRITTEN WARNING NOTICE</h2>
                    </div>
            ...
            <div class="about-content" style="margin-top: 2rem;">
                <p>Subject : {{ $letters->warning_subject }}</p> 
                <p>Incident Date : {{ date('d M Y',strtotime($letters->warning_incident_date)) }}</p>
                <p>Policy Violated : {{ $letters->policy_violated}}</p>
            </div>
            
            <div style="margin-top: 2rem;">
                <p>This letter serves as an official written warning regarding your recent conduct:</p>
                <br>{!! $letters->warning_incident_discription !!}<br>
                <p>You are required to submit a written explanation within 3 working days.</p>
            </div>
