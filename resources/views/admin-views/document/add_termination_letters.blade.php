    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">{{ \App\CPU\translate('termination_letters') }}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ \App\CPU\translate('termination_letters') }} {{ \App\CPU\translate('Table') }}</h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <a title="{{ \App\CPU\translate('View') }}" target="_blank"
                                                    ...
                                                    href="{{ route('admin.document.generate_termination_letter', [$de_p->id]) }}">
                                                    View Letter
                                                </a>
                                            </td>
                            ...
                            @if (count($letters) == 0)
                                <div class="text-center p-4">
                                    ...
                                    <p class="mb-0">{{ \App\CPU\translate('No Termination letter issued') }}</p>
                                </div>
                            @endif
                        </div>
                    </div>
