<?php return array (
  ...
  'Are_you_sure_delete_this_district' => 'Are you sure delete this district',
  'District' => 'District',
  ...
  'Are_you_sure_delete_this_member' => 'Are you sure delete this member',
  ...
  'unit_name' => 'Unit name',
  'meghala_name' => 'Meghala name',
  'district_name' => 'District name',
  'Member Add' => 'Member Add',
  'Updated_successfully' => 'Updated successfully',
  'date_of_birth' => 'Date of birth',
  'Help Provided List' => 'Help Provided List',
  'Death List' => 'Death List',
  'death_list' => 'Death list',
  'Help_Provided_list' => 'Help Provided list',
  'credited_amount' => 'Credited amount',
  'Import Transaction File' => 'Import Transaction File',
  'Transaction Import' => 'Transaction Import',
  'credited_date' => 'Credited date',
  'Help Provided' => 'Help Provided',
  'update_help' => 'Update help',
  'cheque_number' => 'Cheque number',
  'age' => 'Age',
  'date_of_death' => 'Date of death',
  'Help_provided' => 'Help provided',
  'Help_provided_members' => 'Help provided members',
  'died_members' => 'Died members',
  ...
  'member_id' => 'Member id',
  'Import Member File' => 'Import Member File',
  'update_death' => 'Update death',
  'help_image' => 'Help image',
  'upi_id/ date / reference number' => 'Upi id/ date / reference number',
  'date / upi_id / reference number' => 'Date / upi id / reference number',
  'date / reference number' => 'Date / reference number',
  'Search member' => 'Search member',
  'name (DESC)' => 'Name (DESC)',
  'Help Provided (DESC)' => 'Help Provided (DESC)',
  'help_provided (DESC)' => 'Help provided (DESC)',
  'help_provided (ASC)' => 'Help provided (ASC)',
  'death_status (DESC)' => 'Death status (DESC)',
  'death_status (ASC)' => 'Death status (ASC)',
  'status (DESC)' => 'Status (DESC)',
  'status (ASC)' => 'Status (ASC)',
  'balance_amount (DESC)' => 'Balance amount (DESC)',
  'balance_amount (ASC)' => 'Balance amount (ASC)',
  'upi_id (DESC)' => 'Upi id (DESC)',
  'upi_id (ASC)' => 'Upi id (ASC)',
  'mobile (DESC)' => 'Mobile (DESC)',
  'mobile (ASC)' => 'Mobile (ASC)',
  'akpa_id (DESC)' => 'Akpa id (DESC)',
  'akpa_id (ASC)' => 'Akpa id (ASC)',
  'nominee_name (DESC)' => 'Nominee name (DESC)',
  'nominee_name (ASC)' => 'Nominee name (ASC)',
  'unit_name (DESC)' => 'Unit name (DESC)',
  'unit_name (ASC)' => 'Unit name (ASC)',
  'meghala_name (DESC)' => 'Meghala name (DESC)',
  'meghala_name (ASC)' => 'Meghala name (ASC)',
  'district_name (DESC)' => 'District name (DESC)',
  'district_name (ASC)' => 'District name (ASC)',
  'name (ASC)' => 'Name (ASC)',
  ...
  'sanjeevani_id' => 'Sanjeevani id',
  'other_document_details' => 'Other document details',
  'place' => 'Place',
  'aadhaar_number' => 'Aadhaar number',
  'Meghala Login' => 'Meghala Login',
  'Meghala | Login' => 'Meghala | Login',
  'Unit Login' => 'Unit Login',
  'DAY BOOK LOGIN' => 'DAY BOOK LOGIN',
  'DAY BOOK | LOGIN' => 'DAY BOOK | LOGIN',
  'district_deleted_successfully' => 'District deleted successfully',
  'district_deactivated_successfully' => 'District deactivated successfully',
  'district_activated_successfully' => 'District activated successfully',
  'daybook_title' => 'Daybook title',
  ...
  'district_update_form' => 'District update form',
  'add_district' => 'Add district',
  'meghala_deleted_successfully' => 'Meghala deleted successfully',
  'unit_deleted_successfully' => 'Unit deleted successfully',
  'balance detail' => 'Balance detail',
  'day book' => 'Day book',
  'participant' => 'Participant',
  'category_deleted_successfully' => 'Category deleted successfully',
  'category_update_form' => 'Category update form',
  ...
  'participant_update_form' => 'Participant update form',
  'participant_table' => 'Participant table',
  'day_book_deleted_successfully' => 'Day book deleted successfully',
  'Are_you_sure_delete_this_day_book' => 'Are you sure delete this day book',
  'Search_by_day_book' => 'Search by day book',
  'day_book_table' => 'Day book table',
  'category_id' => 'Category id',
  'participant_id' => 'Participant id',
  'invoice_number' => 'Invoice number',
  'day_book_form' => 'Day book form',
  'add_day_book' => 'Add day book',
  'Day book' => 'Day book',
  'Balance' => 'Balance',
  'Participant' => 'Participant',
  'Invoice Number' => 'Invoice Number',
  'Day Book' => 'Day Book',
  'day_book_update_form' => 'Day book update form',
  'add_category' => 'Add category',
  'Balance detail' => 'Balance detail',
  'add_balancedetail' => 'Add balancedetail',
  'balancedetail_form' => 'Balancedetail form',
  'balancedetail_table' => 'Balancedetail table',
  'Search_by_balancedetail' => 'Search by balancedetail',
  'Are_you_sure_delete_this_balancedetail' => 'Are you sure delete this balancedetail',
  'balancedetail_deleted_successfully' => 'Balancedetail deleted successfully',
  'balancedetail_update_form' => 'Balancedetail update form',
  'Annual Budget' => 'Annual Budget',
  'Day to day Budget' => 'Day to day Budget',
  ...
  'Balance List' => 'Balance List',
  'Search day_book' => 'Search day book',
  'Are_you_sure_delete_this_meghala' => 'Are you sure delete this meghala',
  ...
  'Search_by_participant' => 'Search by participant',
  'participant_activated_successfully' => 'Participant activated successfully',
  'participant_deactivated_successfully' => 'Participant deactivated successfully',
  'Are_you_sure_delete_this_participant' => 'Are you sure delete this participant',
  'Meghala' => 'Meghala',
  'meghala_form' => 'Meghala form',
  'meghala_table' => 'Meghala table',
  'Search_by_meghala' => 'Search by meghala',
  'meghala_activated_successfully' => 'Meghala activated successfully',
  'meghala_deactivated_successfully' => 'Meghala deactivated successfully',
  'add_unit' => 'Add unit',
  'unit_form' => 'Unit form',
  'unit_table' => 'Unit table',
  'Search_by_unit' => 'Search by unit',
  'unit_activated_successfully' => 'Unit activated successfully',
  'unit_deactivated_successfully' => 'Unit deactivated successfully',
  'Are_you_sure_delete_this_unit' => 'Are you sure delete this unit',
  'meghala_update_form' => 'Meghala update form',
  'unit_update_form' => 'Unit update form',
  'User management' => 'User management',
  'Committee management' => 'Committee management',
  'Account management' => 'Account management',
  'state_commitee' => 'State commitee',
  'add_state_commitee' => 'Add state commitee',
  'state_commitee_form' => 'State commitee form',
  'state_commitee_table' => 'State commitee table',
  'Search_by_state_commitee' => 'Search by state commitee',
  'state_commitee_activated_successfully' => 'State commitee activated successfully',
  'state_commitee_deactivated_successfully' => 'State commitee deactivated successfully',
  'Are_you_sure_delete_this_state_commitee' => 'Are you sure delete this state commitee',
  'state_commitee_deleted_successfully' => 'State commitee deleted successfully',
  'state_commitee_update_form' => 'State commitee update form',
  'district_commitee' => 'District commitee',
  'district_commitee_form' => 'District commitee form',
  'district_commitee_table' => 'District commitee table',
  'Search_by_district_commitee' => 'Search by district commitee',
  'district_commitee_activated_successfully' => 'District commitee activated successfully',
  'district_commitee_deactivated_successfully' => 'District commitee deactivated successfully',
  'Are_you_sure_delete_this_district_commitee' => 'Are you sure delete this district commitee',
  'district_commitee_deleted_successfully' => 'District commitee deleted successfully',
  'district_commitee_update_form' => 'District commitee update form',
  'meghala_commitee' => 'Meghala commitee',
  'add_meghala_commitee' => 'Add meghala commitee',
  'meghala_commitee_form' => 'Meghala commitee form',
  'meghala_commitee_table' => 'Meghala commitee table',
  'Search_by_meghala_commitee' => 'Search by meghala commitee',
  'meghala_commitee_activated_successfully' => 'Meghala commitee activated successfully',
  'meghala_commitee_deactivated_successfully' => 'Meghala commitee deactivated successfully',
  'Are_you_sure_delete_this_meghala_commitee' => 'Are you sure delete this meghala commitee',
  'meghala_commitee_deleted_successfully' => 'Meghala commitee deleted successfully',
  'meghala_commitee_update_form' => 'Meghala commitee update form',
  'Audit management' => 'Audit management',
  'day book audit' => 'Day book audit',
  'balance detail audit' => 'Balance detail audit',
  'Day to day Budget audit' => 'Day to day Budget audit',
  'total Users' => 'Total Users',
  'total Income' => 'Total Income',
  'total Expense' => 'Total Expense',
  'total Balance' => 'Total Balance',
  'TaskMaster | LOGIN' => 'TaskMaster | LOGIN',
  'LOGIN' => 'LOGIN',
  ...
  'project' => 'Project',
  'my task' => 'My task',
  'staff task' => 'Staff task',
  'TaskMaster management' => 'TaskMaster management',
  'add_staff' => 'Add staff',
  'staff_form' => 'Staff form',
  'staff_table' => 'Staff table',
  'Search_by_staff' => 'Search by staff',
  'Search staff' => 'Search staff',
  'Are_you_sure_delete_this_staff' => 'Are you sure delete this staff',
  ...
  'staff_update_form' => 'Staff update form',
  'user_type' => 'User type',
  'Staff_inactive_successfully' => 'Staff inactive successfully',
  'Staff_active_successfully' => 'Staff active successfully',
  'project_deleted_successfully' => 'Project deleted successfully',
  'Are_you_sure_delete_this_project' => 'Are you sure delete this project',
  'project_inactive_successfully' => 'Project inactive successfully',
  'project_active_successfully' => 'Project active successfully',
  ...
  'Are_you_sure_delete_this_task' => 'Are you sure delete this task',
  'task_inactive_successfully' => 'Task inactive successfully',
  'task_active_successfully' => 'Task active successfully',
  ...
  'agile_work_detail' => 'Agile work detail',
  'task info' => 'Task info',
  'Task ID' => 'Task ID',
  'task details' => 'Task details',
  'tasks' => 'Tasks',
  'task Details' => 'Task Details',
  'task_update_form' => 'Task update form',
  'Search staff task' => 'Search staff task',
  'Search_by_stafftask' => 'Search by stafftask',
  'staff task_table' => 'Staff task table',
  'staff task ID' => 'Staff task ID',
  'staff task details' => 'Staff task details',
  'staff tasks' => 'Staff tasks',
  'staff task Details' => 'Staff task Details',
  'stafftask_update_form' => 'Stafftask update form',
  'tech_lead_approval' => 'Tech lead approval',
  'ceo_approval' => 'Ceo approval',
  'team_lead_approval' => 'Team lead approval',
  'team_lead_remark' => 'Team lead remark',
  'team_lead_name' => 'Team lead name',
  'tech_lead_remarks' => 'Tech lead remarks',
  'tech_lead_adjusted_time' => 'Tech lead adjusted time',
  'reviewed_tech_lead_name' => 'Reviewed tech lead name',
  ...
  'ceo_approval_successfully' => 'Ceo approval successfully',
  'Backlogs' => 'Backlogs',
  'Search backlog' => 'Search backlog',
  'backlog' => 'Backlog',
  'add_backlog' => 'Add backlog',
  'backlog_form' => 'Backlog form',
  'backlog_number' => 'Backlog number',
  'backlog_name' => 'Backlog name',
  'backlog_description' => 'Backlog description',
  'backlog_table' => 'Backlog table',
  'Search_by_backlog' => 'Search by backlog',
  'Are_you_sure_delete_this_backlog' => 'Are you sure delete this backlog',
  'backlog_deleted_successfully' => 'Backlog deleted successfully',
  'add_to_task' => 'Add to task',
  'backlog_add_to_task_successfully' => 'Backlog add to task successfully',
  'sprint_name' => 'Sprint name',
  'backlog info' => 'Backlog info',
  'Backlog ID' => 'Backlog ID',
  'backlog details' => 'Backlog details',
  'backlog_update_form' => 'Backlog update form',
  'backlogs' => 'Backlogs',
  'backlog Details' => 'Backlog Details',
  'otp' => 'Otp',
  'TaskMaster | Verify' => 'TaskMaster | Verify',
  'enter otp' => 'Enter otp',
  'Import' => 'Import',
  'Import Backlogs' => 'Import Backlogs',
  'backlog Bulk Import' => 'Backlog Bulk Import',
  'After uploading backlog you need to edit them and set backlog images and choices' => 'After uploading backlog you need to edit them and set backlog images and choices',
  'Import backlog File' => 'Import backlog File',
  'You can get project id from their list, please input the right ids' => 'You can get project id from their list  please input the right ids',
  'test cases' => 'Test cases',
  'test_case_updated' => 'Test case updated',
  'Search testcase' => 'Search testcase',
  'Search_by_testcase' => 'Search by testcase',
  'testcase_table' => 'Testcase table',
  ...
  'testcases' => 'Testcases',
  'testcase Details' => 'Testcase Details',
  'testcase_update_form' => 'Testcase update form',
  'tester_remark' => 'Tester remark',
  'Assigned To' => 'Assigned To',
  'time_edit_successfully' => 'Time edit successfully',
  'experience' => 'Experience',
  'qualification' => 'Qualification',
  'monthly_rate in $' => 'Monthly rate in $',
  'Hire Staffs' => 'Hire Staffs',
  'hire_table' => 'Hire table',
  'hourly_rate in $' => 'Hourly rate in $',
  'hire' => 'Hire',
  'Search hire' => 'Search hire',
  'Search_by_hire' => 'Search by hire',
  'hire_request_sent_successfully' => 'Hire request sent successfully',
  'hire_now' => 'Hire now',
  'Are_you_sure_to_hire_this_staff' => 'Are you sure to hire this staff',
  'Hire Requests' => 'Hire Requests',
  'Search hire_request' => 'Search hire request',
  'hire_request_table' => 'Hire request table',
  ...
  'Punching System Data' => 'Punching System Data',
  'task_ended_successfully' => 'Task ended successfully',
  'End' => 'End',
  'Are_you_sure_end_this_task' => 'Are you sure end this task',
  'task_resumed_successfully' => 'Task resumed successfully',
  'Resume' => 'Resume',
  'Are_you_sure_resume_this_task' => 'Are you sure resume this task',
  'task_paused_successfully' => 'Task paused successfully',
  'Pause' => 'Pause',
  'Are_you_sure_pause_this_task' => 'Are you sure pause this task',
  'task_started_successfully' => 'Task started successfully',
  'Are_you_sure_start_this_task' => 'Are you sure start this task',
  'Post Usage Report' => 'Post Usage Report',
  'post_usage_report' => 'Post usage report',
  'post_usage_report_table' => 'Post usage report table',
  'Your task will be changed to completed and cannot be reverted' => 'Your task will be changed to completed and cannot be reverted',
  'Are you sure end this task' => 'Are you sure end this task',
  'task_restarted_successfully' => 'Task restarted successfully',
  'task_restart' => 'Task restart',
  'Are_you_sure_restart_this_task' => 'Are you sure restart this task',
  'The completed task will be converted to progress' => 'The completed task will be converted to progress',
  'Punching Report' => 'Punching Report',
  'punching_report' => 'Punching report',
  'Proposal' => 'Proposal',
  'proposal' => 'Proposal',
  ...
  'min_expected_amount in $' => 'Min expected amount in $',
  'max_expected_amount in $' => 'Max expected amount in $',
  'proposal_table' => 'Proposal table',
  'Search_by_proposal' => 'Search by proposal',
  'Search proposal' => 'Search proposal',
  'proposal_active_successfully' => 'Proposal active successfully',
  'proposal_inactive_successfully' => 'Proposal inactive successfully',
  'Are_you_sure_delete_this_proposal' => 'Are you sure delete this proposal',
  'proposal info' => 'Proposal info',
  'Proposal ID' => 'Proposal ID',
  'proposal_update_form' => 'Proposal update form',
  'Generate Pdf' => 'Generate Pdf',
  'max_expected_amount' => 'Max expected amount',
  'min_expected_amount' => 'Min expected amount',
  'Proposal id' => 'Proposal id',
  'Proposal date' => 'Proposal date',
  'Cozysta Proposal' => 'Cozysta Proposal',
  'proposal Details' => 'Proposal Details',
  'proposals' => 'Proposals',
  'proposal details' => 'Proposal details',
  'Quotations' => 'Quotations',
  'quotation_deleted_successfully' => 'Quotation deleted successfully',
  'Are_you_sure_delete_this_quotation' => 'Are you sure delete this quotation',
  'quotation_inactive_successfully' => 'Quotation inactive successfully',
  'quotation_active_successfully' => 'Quotation active successfully',
  'Search quotation' => 'Search quotation',
  'Search_by_quotation' => 'Search by quotation',
  'quotation ID' => 'Quotation ID',
  'quotation info' => 'Quotation info',
  'quotation details' => 'Quotation details',
  'quotation_table' => 'Quotation table',
  'quotation_update_form' => 'Quotation update form',
  'quotation' => 'Quotation',
  'quotation_number' => 'Quotation number',
  'quotation_date' => 'Quotation date',
  'min_amount in $' => 'Min amount in $',
  'max_amount in $' => 'Max amount in $',
  'add_quotation' => 'Add quotation',
  'quotation_form' => 'Quotation form',
  'status_successfully' => 'Status successfully',
  'invoices' => 'Invoices',
  'invoice_deleted_successfully' => 'Invoice deleted successfully',
  'Are_you_sure_delete_this_invoice' => 'Are you sure delete this invoice',
  'invoice_inactive_successfully' => 'Invoice inactive successfully',
  'invoice_active_successfully' => 'Invoice active successfully',
  'Search invoice' => 'Search invoice',
  'Search_by_invoice' => 'Search by invoice',
  'invoice_table' => 'Invoice table',
  'quotations' => 'Quotations',
  'invoice info' => 'Invoice info',
  'invoice_update_form' => 'Invoice update form',
  'renewal_date' => 'Renewal date',
  'payment_date' => 'Payment date',
  'cost_of_invoice in $' => 'Cost of invoice in $',
  ...
  'client_active_successfully' => 'Client active successfully',
  'client_inactive_successfully' => 'Client inactive successfully',
  'Are_you_sure_delete_this_client' => 'Are you sure delete this client',
  'client_deleted_successfully' => 'Client deleted successfully',
  'client Details' => 'Client Details',
  'client details' => 'Client details',
  'client ID' => 'Client ID',
  'client info' => 'Client info',
  'client_update_form' => 'Client update form',
  'due_date' => 'Due date',
  'notes' => 'Notes',
  'quotation Details' => 'Quotation Details',
  'Add Items' => 'Add Items',
  ...
  'Receipts' => 'Receipts',
  'Add new receipts' => 'Add new receipts',
  'receipts_removed_successfully' => 'Receipts removed successfully',
  'receipt_number' => 'Receipt number',
  'Are_you_sure_remove_this_receipts' => 'Are you sure remove this receipts',
  ...
  'Import lead File' => 'Import lead File',
  'You can get ids from their list, please input the right ids' => 'You can get ids from their list  please input the right ids',
  'Are_you_sure_delete_this_lead' => 'Are you sure delete this lead',
  'Search_by_lead' => 'Search by lead',
  'lead_table' => 'Lead table',
  'lead_notes' => 'Lead notes',
  'lead_sourse' => 'Lead sourse',
  ...
  'add_lead' => 'Add lead',
  'lead' => 'Lead',
  'lead_update_form' => 'Lead update form',
  'lead info' => 'Lead info',
  'leads_deleted_successfully' => 'Leads deleted successfully',
  'Proceed' => 'Proceed',
  'lead Bulk Import' => 'Lead Bulk Import',
  'successfully changed' => 'Successfully changed',
  'candidates' => 'Candidates',
  'candidate_deleted_successfully' => 'Candidate deleted successfully',
  'Import candidate File' => 'Import candidate File',
  'candidate' => 'Candidate',
  'Are_you_sure_delete_this_candidate' => 'Are you sure delete this candidate',
  'Search_by_candidate' => 'Search by candidate',
  ...
  'interview_removed_successfully' => 'Interview removed successfully',
  'Are_you_sure_remove_this_interviews' => 'Are you sure remove this interviews',
  'interview' => 'Interview',
  ...
  'Convert to Staff' => 'Convert to Staff',
  'offer_letters' => 'Offer letters',
  'Add new offer_letters' => 'Add new offer letters',
  'Are_you_sure_remove_this_offer_letters' => 'Are you sure remove this offer letters',
  'offer_letters_removed_successfully' => 'Offer letters removed successfully',
  'terms_and_conditions' => 'Terms and conditions',
  'releiving_letters' => 'Releiving letters',
  'Add new releiving_letters' => 'Add new releiving letters',
  'Are_you_sure_remove_this_releiving_letters' => 'Are you sure remove this releiving letters',
  'releiving_letters_removed_successfully' => 'Releiving letters removed successfully',
  'releiving_date' => 'Releiving date',
  'dues_cleared' => 'Dues cleared',
  'experience_certificate_issued' => 'Experience certificate issued',
  'notice_period_served' => 'Notice period served',
  'warning_letters' => 'Warning letters',
  'Add new warning_letters' => 'Add new warning letters',
  'Are_you_sure_remove_this_warning_letters' => 'Are you sure remove this warning letters',
  'warning_letters_removed_successfully' => 'Warning letters removed successfully',
  'policy_violated' => 'Policy violated',
  'warning_incident_date' => 'Warning incident date',
  'warning_subject' => 'Warning subject',
  'warning_incident_discription' => 'Warning incident discription',
  'termination_letters_removed_successfully' => 'Termination letters removed successfully',
  'Are_you_sure_remove_this_termination_letters' => 'Are you sure remove this termination letters',
  'experiences_removed_successfully' => 'Experiences removed successfully',
  'experience_description' => 'Experience description',
  'Are_you_sure_remove_this_experiences' => 'Are you sure remove this experiences',
  'employement_end_date' => 'Employement end date',
  'employement_start_date' => 'Employement start date',
  'Add new experiences' => 'Add new experiences',
  'experience certificates' => 'Experience certificates',
  'candidate Bulk Import' => 'Candidate Bulk Import',
  'settlement_process' => 'Settlement process',
  'Edit item' => 'Edit item',
  'Edit receipts' => 'Edit receipts',
  'Edit offer_letters' => 'Edit offer letters',
  'TaskMaster | Candidate Registration' => 'TaskMaster | Candidate Registration',
  'Cosysta | Candidate Registration' => 'Cosysta | Candidate Registration',
  'reason' => 'Reason',
  ...
  'point_setting_update_form' => 'Point setting update form',
  'items' => 'Items',
  'points' => 'Points',
  'leader_board' => 'Leader board',
  'Experience Certificate' => 'Experience Certificate',
  'Offer Letter' => 'Offer Letter',
  'Releiving Letters' => 'Releiving Letters',
  'Warning Letters' => 'Warning Letters',
  'Termination Letters' => 'Termination Letters',
  'releiving_letter' => 'Releiving letter',
  'No Warning letter issued' => 'No Warning letter issued',
  'No Termination letter issued' => 'No Termination letter issued',
  'No Experience Certificate issued' => 'No Experience Certificate issued',
  'termination_letters' => 'Termination letters',
  'experiences' => 'Experiences',
  'No Releiving letter issued' => 'No Releiving letter issued',
  'No offer letter issued' => 'No offer letter issued',
  'Your name' => 'Your name',
  ...
  'candidate_update_form' => 'Candidate update form',
  'candidate details' => 'Candidate details',
  'candidate Details' => 'Candidate Details',
  'portfolio_link' => 'Portfolio link',
  'last_qualification_certificate' => 'Last qualification certificate',
  'degree_mark_percentage' => 'Degree mark percentage',
  'Personality Test Result' => 'Personality Test Result',
  'Last Qualification Certificate' => 'Last Qualification Certificate',
  'Portfolio Link' => 'Portfolio Link',
  'tenth_mark_percentage' => 'Tenth mark percentage',
  'twelveth_mark_percentage' => 'Twelveth mark percentage',
  'Cosysta | Personality Test' => 'Cosysta | Personality Test',
  'Quotation Report' => 'Quotation Report',
  'invoice ID' => 'Invoice ID',
  'portfolio Link' => 'Portfolio Link',
  'Invoice Report' => 'Invoice Report',
  'Search invoice_report' => 'Search invoice report',
  'invoice_report' => 'Invoice report',
  'Search_by_invoice_report' => 'Search by invoice report',
  'Other Certificates' => 'Other Certificates',
  'certificates' => 'Certificates',
  'Certificates' => 'Certificates',
  'certificate_deleted_successfully' => 'Certificate deleted successfully',
  'Are_you_sure_delete_this_certificate' => 'Are you sure delete this certificate',
  'Search_by_certificate' => 'Search by certificate',
  ...
  'certificate_update_form' => 'Certificate update form',
  'add_certificate' => 'Add certificate',
  'certificate_form' => 'Certificate form',
  'certificate Details' => 'Certificate Details',
  'Add new certificate' => 'Add new certificate',
  'certificates_removed_successfully' => 'Certificates removed successfully',
  'Are_you_sure_remove_this_certificates' => 'Are you sure remove this certificates',
  'Edit experiences' => 'Edit experiences',
  'Interviewer name' => 'Interviewer name',
  'google_meet_link' => 'Google meet link',
  'Interviewers' => 'Interviewers',
  'interview_table' => 'Interview table',
  ...
  'Marks' => 'Marks',
  'marks' => 'Marks',
  'Are_you_sure_remove_this_marks' => 'Are you sure remove this marks',
  'marks_removed_successfully' => 'Marks removed successfully',
  'Interviewer' => 'Interviewer',
  'Candidate' => 'Candidate',
  'direct_pdf' => 'Direct pdf',
  'successfully updated' => 'Successfully updated',
  'interview details' => 'Interview details',
  'Edit releiving_letters' => 'Edit releiving letters',
  'OK' => 'OK',
  'The messages are being sent to selected candidates.' => 'The messages are being sent to selected candidates.',
  'Email Sent' => 'Email Sent',
  'Message Sent' => 'Message Sent',
  'Your branch' => 'Your branch',
  'Your bank_name' => 'Your bank name',
  'account_holder_name' => 'Account holder name',
  'Your account_holder_name' => 'Your account holder name',
  'account_number' => 'Account number',
  'Your account_number' => 'Your account number',
  'ifsc_code' => 'Ifsc code',
  'Your ifsc_code' => 'Your ifsc code',
  'Salary Report' => 'Salary Report',
  'salary_report' => 'Salary report',
  'interview Details' => 'Interview Details',
  'The messages are being sent to selected leads.' => 'The messages are being sent to selected leads.',
  'HR Questions' => 'HR Questions',
  'The messages are being sent to selected clients.' => 'The messages are being sent to selected clients.',
  'The messages are being sent to selected staffs.' => 'The messages are being sent to selected staffs.',
  'The messages are being sent to selected client.' => 'The messages are being sent to selected client.',
  'jobs' => 'Jobs',
  ...
  'add_job' => 'Add job',
  'job' => 'Job',
  'job_update_form' => 'Job update form',
  'quotation_report_table' => 'Quotation report table',
  'invoice_report_table' => 'Invoice report table',
  'lead Details' => 'Lead Details',
  'inventory' => 'Inventory',
  ...
  'Are_you_sure_delete_this_inventory' => 'Are you sure delete this inventory',
  'inventory_deleted_successfully' => 'Inventory deleted successfully',
  'inventory_view' => 'Inventory view',
  'inventory_update_form' => 'Inventory update form',
  'Settingssssss' => 'Settingssssss',
  'CRM' => 'CRM',
  'Purchase Management' => 'Purchase Management',
  'Quotation Management' => 'Quotation Management',
  'project_inventory_planning' => 'Project inventory planning',
